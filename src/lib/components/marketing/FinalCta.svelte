<section class="marketing-card p-6 sm:p-9">
	<div class="rounded-xl border border-emerald-200 bg-gradient-to-r from-emerald-50 to-cyan-50 p-6 sm:p-8">
		<span class="section-kicker">Ready when you are</span>
		<h2 class="section-title">See xNews in your real workflow.</h2>
